...
export default async function Page() {
  ...
  if (!escolaId) {
    return (
      <PortalLayout>
        <AuditPageView portal="financeiro" action="PAGE_VIEW" entity="exportacoes" />
        <div className="p-4 bg-amber-50 border border-amber-200 rounded text-amber-800 text-sm">
          Vincule seu perfil a uma escola para exportar relatórios.
        </div>
      </PortalLayout>
    )
  }
      ...
      <div className="bg-white rounded-xl shadow border p-5">
        ...
        {!allowed ? (
          ...
          <div className="text-sm text-gray-600">
            Em breve: Exportar relatórios em Excel e PDF com um clique.
          </div>
        )}
      </div>
    </PortalLayout>
